        ...
        <div className="container">
          <div className="row mb-5 align-items-center">
            ...
            <div className="col-lg-5 pl-lg-5">
              ...
              <p className="lead">
                Computer Engineering student at Universidad Católica Andrés
                Bello in Caracas, Venezuela.
              </p>
              <p className="mb-5">
                I'm a dual Venezuelan-Spanish citizen with experience in web
                development and access management who seeks an entry-level job
                position in web development.
              </p>

              <p>
                <a
                  href="https://drive.google.com/file/d/1--11y4guh2hxKmPokyxEy7FH6jOH_G1b/view?usp=drivesdk"
