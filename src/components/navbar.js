            ...
            <div className="container">
                ...
                <div className="collapse navbar-collapse justify-content-md-center" id="navbar">
                    <ul className="navbar-nav">
                        ...
                        <li className="nav-item"><a className="nav-link" href="#section-tools">Tools</a></li>
                        <li className="nav-item"><a className="nav-link" href="#section-projects">Projects</a></li>
                        <li className="nav-item"><a className="nav-link" href="#section-resume">Resume</a></li>
                        <li className="nav-item"><a className="nav-link" href="#site-footer">Find me</a></li>
                    </ul>
                </div>
            </div>
        </nav>
